...
?>
    ...
    <html>
            <head>
                    <title>Question Pool:Departments</title>
            ...
            <body style="background-color:LightSlateGrey;">
              ...
              <div class="container" style="display:none; background-color:#274156;" >

                  <h1 style="font-size:200%;font-family:Segoe, 'Segoe UI', Calibri, Arial, sans-serif;color:Lavender;">Question Pool</h1>
                  <h2 style="font-size:100%;font-family:Segoe, 'Segoe UI', Calibri, Arial, sans-serif;color:Lavender;">
...
echo 'Sorry, You are not logged in.';
    ...
    while($result && $row = mysqli_fetch_assoc( $result ) ){
      echo
      "<a href='./department.php?dept_id={$row['dept_id']}' class='list-group-item'   >
          <h4 onMouseOver='this.style.color=\"white\"' onMouseOut='this.style.color=\"Black\"' class='list-group-item-heading'>{$row['dept_name']}</h4>
